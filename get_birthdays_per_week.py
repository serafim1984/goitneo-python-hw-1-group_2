...
# get_birthdays_per_week([{"name": "Bill Gates", "birthday": datetime(1955, 12, 5)}, 
#                        {"name": "Elon Musk", "birthday": datetime(1966, 12, 6)}, 
#                        {"name": "Madonna", "birthday": datetime(1970, 12, 5)}, 
#                        {"name": "Bill Murrey", "birthday": datetime(1970, 12, 3)}, 
#                        {"name": "Jeff Frisker", "birthday": datetime(1970, 12, 2)}, 
#                        {"name": "Elen Glister", "birthday": datetime(1970, 11, 2)}, 
#                        {"name": "Viven Pfafer", "birthday": datetime(1970, 12, 25)},
#                        ])
